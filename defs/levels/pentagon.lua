...
local data = {
	...
	lines = {
		...
		util.RotateLineAroundOrigin(basis, math.pi*1/5),
		util.RotateLineAroundOrigin(basis, math.pi*2/5),
		util.RotateLineAroundOrigin(basis, math.pi*3/5),
		util.RotateLineAroundOrigin(basis, math.pi*4/5),
